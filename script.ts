...
const crousalBox = document.getElementById("crausel-box") as HTMLElement;
const addEducationBtn = document.getElementById("add-education-btn") as HTMLButtonElement;
const educationBox = document.getElementById("education-box") as HTMLElement;
const addSkillBtn = document.getElementById("add-skill-btn") as HTMLButtonElement;
const skillsBox = document.getElementById("skills-box") as HTMLElement;
const addExperienceBtn = document.getElementById("add-experience-btn") as HTMLButtonElement;
const experienceBox = document.getElementById("experience-box") as HTMLElement;
...
const createItem = (htmlContent: string, container: HTMLElement, removeClass: string) => {
